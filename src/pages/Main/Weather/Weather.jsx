...
export const Weather = ({ city, setDeletedCities }) => {
            ...
            >
              ...
              <div className={style.weather__managment}>
                ...
                >
                  ...
                  >
                    <rect width="30" height="30" fill="url(#pattern0_11_41)" />
                    <defs>
                      <pattern
                        id="pattern0_11_41"
                ...
                <button className={style.weather__more} type="button">
                  See more
                </button>
                <button
                  onClick={() =>
                ...
                >
                  <svg
                    ...
                    link="http://www.w3.org/1999/xlink"
                  >
                    <rect width="30" height="30" fill="url(#pattern0_11_43)" />
                    <defs>
                      <pattern
                        id="pattern0_11_43"
                        patternContentUnits="objectBoundingBox"
            ...
            >
              ...
              <div className={style.weather__managment}>
                ...
                <button
                  ...
                  type="button"
                >
                  {favoriteCities.some((city) => city.id === cityWeather.id) ? (
                    <FaHeart size={30} style={{ fill: "#fb4646" }} />
                  ) : (
                    <FaRegHeart size={30} style={{ fill: "#fb4646" }} />
                  )}
